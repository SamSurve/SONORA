...
class TestSonoraApiEndpoints:
    ...
    def test_job_submission_and_status_retrieval(self) -> None:
    ...
    def test_job_cancellation_endpoint(self) -> None:
    ...
    def test_file_download_uncompleted_job_returns_400(self) -> None:
        ...
        file_res = client.get(f"/api/v1/downloads/{job_id}/file")
        assert file_res.status_code == 400

    def test_nonexistent_job_returns_404(self) -> None:
        """Verifies querying non-existent job ID returns 404."""
